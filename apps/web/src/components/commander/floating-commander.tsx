...
/**
 * Specific error messages generated by the catch block in sendMessage.
 * Only match the exact hardcoded fallback strings — never partial/common words
 * that could appear in legitimate assistant responses.
 */
...
function isErrorMessage(msg: StoredMessage): boolean {
  ...
  return ERROR_MESSAGES.some((err) => msg.content === err);
}
